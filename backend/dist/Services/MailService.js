...
class MailService {
    ...
    static sendMail(options) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const config = yield (0, settings_1.getEmailSettings)();
                ...
                const timeoutPromise = new Promise((_, reject) => setTimeout(() => reject(new Error("Mail gönderimi zaman aşımına uğradı")), 10000));
                yield Promise.race([sendPromise, timeoutPromise]);
    ...
    static sendContactNotification(data) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    static sendApplicationNotification(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const config = yield (0, settings_1.getEmailSettings)();
            const targetEmail = config.application_email || config.email_user;
            // Görsel path'i /uploads ile başlıyorsa dosyadan base64 oku
            function imgHtml(label, url) {
                if (!url)
                    return "";
                let src = url;
                if (url.startsWith("/uploads")) {
                    // Sunucu kökünden dosya yolu oluştur
                    const absPath = path_1.default.join(process.cwd(), "src", url);
                    const base64 = (0, fileToBase64_1.fileToBase64)(absPath);
                    if (base64)
                        src = base64;
                }
    ...
    static sendConfirmApplicationEmail(email, aplicationCode, fullName, phone) {
        return __awaiter(this, void 0, void 0, function* () {
            const targetEmail = email;
            const htmlContent = `
   <div style="font-family: Arial, sans-serif; padding: 20px; max-width: 600px; color: #333;">
